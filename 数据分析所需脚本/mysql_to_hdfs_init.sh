...
APP=gmall
sqoop=/export/servers/sqoop-1.4.6/bin/sqoop
...
import_data(){
$sqoop import \
--connect jdbc:mysql://hadoop103:3306/$APP \
--username root \
--password 123456 \
...
hadoop jar /export/servers/hadoop-3.1.3/share/hadoop/common/hadoop-lzo-0.4.20.jar com.hadoop.compression.lzo.DistributedLzoIndexer /origin_data/$APP/db/$1/$do_date
}
